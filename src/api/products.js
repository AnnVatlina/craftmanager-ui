...
export const productsApi = {
  ...
  updateProduction: (id, productionId, data) => api.put(`/api/v1/products/${id}/productions/${productionId}`, data),
  deleteProduction: (id, productionId) => api.delete(`/api/v1/products/${id}/productions/${productionId}`),
